...
public class ConnectDB {
	...
	private static String dbUrl = "jdbc:mysql://localhost:3306/db_webdiary?user=root&password=123456&useUnicode=true";
	public ConnectDB() { // 构造方法
		try { // 捕捉异常
	...
	public static Connection getConnection() {
		...
		try { // 连接数据库时可能发生异常因此需要捕捉该异常
			...
			// conn=DriverManager.getConnection("jdbc:mysql://localhost:3306/db_webdiary","root","123456");
		} catch (Exception ee) {
	...
	public int executeUpdate(String sql) {
		...
		try { // 捕捉异常
			...
			System.out.println("SQLException=======executeUpdate========="+ex);
		}
